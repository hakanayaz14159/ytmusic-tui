"""File logging for ytmusic-cli. Enabled only when YTMUSIC_LOG=1."""
...
from ytmusic_cli.consts import APP_DIR, LOG_ENV, LOG_FILE_ENV, LOG_LEVEL_ENV

LOGGER_NAME = "ytmusic_cli"
